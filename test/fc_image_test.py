...
class RecaptchaImageRequestTest(unittest.TestCase):
    ...
    def testImagesTypes(self):
        ...
        with self.assertRaises(ValidationError):
            request = FunCaptchaComplexImageTaskRequest(websiteUrl=RecaptchaImageRequestTest.websiteUrlExample,
    ...
    def testUserAgentWithUrl(self):
        with self.assertRaises(UserAgentNotDefinedError):
            request = FunCaptchaComplexImageTaskRequest(metadata=RecaptchaImageRequestTest.metadataExample,
                                                       imagesUrls=RecaptchaImageRequestTest.imageUrlsExamples)
            request.getTaskDict()
